<template>
  <NuxtLink
    ...
    :to="project.link"
    target="_blank"
    class="group relative flex cursor-pointer flex-col gap-1 overflow-hidden rounded-lg transition-all duration-300"
  >
    <!-- Efecto Spotlight (similar al botón) -->
    <div
    ...
    <!-- Capa intermedia (glass morphism) -->
    <div
    ...
    <div class="relative z-10 flex flex-col gap-1 p-1">
      <!-- Puntos de control (ahora con mejor contraste) -->
      ...
      >
        ...
        >
          <div class="flex items-center justify-between gap-2">
            ...
            <div
              class="flex size-6 items-center justify-center rounded-full bg-white/80 dark:bg-zinc-700/80 shadow-sm transition-all duration-500 group-hover:-rotate-45 group-hover:bg-white dark:group-hover:bg-zinc-600"
            >
              <i
    ...
    <!-- Sombra/reflejo inferior (como en SpotlightButton) -->
    <div
