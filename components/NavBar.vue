<template>
  <div class="mx-auto my-4 flex w-full items-center justify-center gap-4">
    <ColorModeButton />
      ...
      >
        ...
        >
          <NuxtLink
            ...
            :class="[
              item.to === route.path
                ? 'border border-black/5 black:border-white/5 black:bg-zinc-900/50 black:text-white/75 text-dark/75 shadow-2xl shadow-black/50 black:shadow-white/50 backdrop-blur-3xl text-shadow-sm'
                : 'text-muted',
            ]"
            :to="item.to"
